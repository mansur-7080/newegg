...
export class PaymentService extends EventEmitter {
   ...
   */
  private async processCardPayment(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
    try {
   ...
   */
  private async processPayPalPayment(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
   ...
   */
  private async processApplePayPayment(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
   ...
   */
  private async processGooglePayPayment(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
   ...
   */
  private async processBankTransfer(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
   ...
   */
  private async processCryptoPayment(paymentId: string, request: PaymentRequest): Promise<PaymentResponse> {
   ...
   */
  async getPaymentsByUserId(userId: string, options?: { limit?: number; offset?: number }): Promise<any[]> {
