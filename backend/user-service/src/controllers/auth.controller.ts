...
export class AuthController {
  ...
  async refreshToken(refreshToken: string) {
    try {
      ...
      logger.error('Token refresh failed', { error: error instanceof Error ? error.message : error });
      throw new AppError('Invalid refresh token', 401);
    }
  }
  ...
  async forgotPassword(email: string) {
    try {
      ...
      logger.error('Forgot password failed', { error: error instanceof Error ? error.message : error });
      throw error;
    }
  }
  ...
  async verifyEmail(token: string) {
    try {
      ...
      logger.error('Email verification failed', { error: error instanceof Error ? error.message : error });
  ...
  async resendVerificationEmail(userId: string) {
    try {
      ...
      logger.error('Resend verification failed', { error: error instanceof Error ? error.message : error });
      throw error;
    }
  }
  ...
  async getCurrentUser(userId: string) {
    try {
      ...
      logger.error('Get current user failed', { error: error instanceof Error ? error.message : error });
      throw error;
    }
  }
  ...
  async changePassword(userId: string, currentPassword: string, newPassword: string) {
    try {
      ...
      logger.error('Change password failed', { error: error instanceof Error ? error.message : error });
      throw error;
    }
  }
