 ...
 * @access  Private
 */
router.post('/addresses', authMiddleware, updateAddressValidation, asyncHandler(async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return res.status(400).json({
      success: false,
 ...
 * @access  Private
 */
router.put('/addresses/:id', authMiddleware, updateAddressValidation, asyncHandler(async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return res.status(400).json({
      success: false,
 ...
 * @access  Private
 */
router.get('/:id/orders', authMiddleware, asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
router.get('/:id/reviews', authMiddleware, asyncHandler(async (req, res) => {
