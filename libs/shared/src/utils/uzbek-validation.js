...
exports.formatUzbekPhoneNumber = formatUzbekPhoneNumber;
exports.validateUzbekPassport = validateUzbekPassport;
exports.validateUzbekJSHIR = validateUzbekJSHIR;
exports.validateUzbekBankCard = validateUzbekBankCard;
...
function formatUzbekPhoneNumber(phone) {
...
function validateUzbekPassport(passport) {
...
function validateUzbekJSHIR(jshir) {
    ...
    const checksum = digits.slice(0, 13).reduce((sum, digit, index) => {
...
function validateUzbekBankCard(cardNumber) {
